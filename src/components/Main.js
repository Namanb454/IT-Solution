      ...
      <div className='lg:pb-0 pb-10'>
        <div className="relative w-full lg:h-screen h-[70vh] overflow-hidden">
          ...
          <div className=''>
            ...
            <h3 className='lg:w-[40%] w-full lg:absolute lg:top-[71%] top-[90%] lg:left-[28%] left-[50%] transform lg:-translate-x-1/2 lg:-translate-y-1/2 z-10 text-white text-base px-3 lg:text-justify text-center'>Empowering Your Business with Reliable IT Solutions for Uninterrupted Growth and Success. </h3>
          </div>
