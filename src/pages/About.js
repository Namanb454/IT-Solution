            ...
            <section class="text-gray-600 body-font">
                <div className='lg:py-20'>
                    ...
                    <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
                        ...
                        <div class="lg:flex-grow md:w-[10%] lg:pl-10 md:pl-16 flex flex-col md:items-start md:text-left text-white">
                            <p class="mb-8 text-gray-300 text-sm text-justify leading-relaxed">Welcome to B&K - Your Trusted IT Solutions Partner
                                                ...
                                                <div key={data.id} class="lg:w-1/2">
                                                    <div class="flex sm:flex-row flex-col items- sm:justify-start text-center sm:text-left">
                                                        ...
                                                        <div class="flex-grow pl-5">
                                                            ...
                                                            <p class="mb-4 text-sm text-gray-300 lg:text-left text-justify">{data.values}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            )
                ...
                <div className='py-10'>
                    ...
                    <div class="container mx-auto flex px-5 py-0 md:flex-row flex-col items-center">
                        <div class=" w-[100%] lg:hidden md:hidden md:w-1/2 mb-10 md:mb-0">
                            <img class="w-full object-cover object-center rounded" alt="hero" src="about1.png" />
                        </div>
                                        ...
                                        {about.map(data => {
                                            return (
                                                <div key={data.id} class="">
                                                    <div class="flex sm:flex-row flex-col items- sm:justify-start text-center sm:text-left">
                                                        <span class="flex-shrink-0 lg:text-6xl text-3xl text-[#6527BE] font-serif font-bold mx-auto rounded-lg w-[25%] h-[30%]">{data.sn}</span>
                                                        <div class="flex-grow pl-5">
                                                            <h2 class="title-font font-bold text-xl text-[#ec634b]">{data.q}</h2>
                                                            {/* <h3 class="text-gray-500 mb-3">UI Developer</h3> */}
                                                            <p class="mb-4 text-sm text-gray-300 text-start">{data.ans}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            )
                        ...
                        <div class=" lg:w-[50%] md:w-1/2 w-0 mb-10 md:mb-0">
                            <img class="w-full h-[50vh]  object-cover object-center rounded" alt="hero" src="about1.png" />
                        </div>
                    </div>
                </div>
            </section>
